...
const cli = cac('create-nuxt-typo3')
...
const showEnvInfo = async () => {
  ...
  const result = await envinfo
    .run({
      ...
      npmGlobalPackages: ['nuxt', 'create-typo3-nuxt-app']
    })
  console.log(result)
  process.exit(1)
}
...
cli
  ...
  .action((outDir = '.', cliOptions) => {
    ...
    console.log()
    console.log(chalk`{cyan create-nuxt-typo3 v${version}}`)
    console.log(chalk`✨  Generating TYPO3 PWA based on Nuxt.js project in {cyan ${outDir}}`)
